...
%error( nargchk( 2, inf, nargin ) ); % This is the original line but nargchk is being phased out in R2016b
narginchk( 2, inf ) ; % Replacement function for the previous line
